...
{{ '/images/testing-a-custom-select-with-react-testing-library/selects.gif' | figure: 'Material-UI\'s select' }}
...
{{ '/images/testing-a-custom-select-with-react-testing-library/custom-select.gif' | figure: 'MySelector in action' }}
