...
![](/images/es6-tail-call-optimization/debug1.png)
...
![](/images/es6-tail-call-optimization/debug2.png)
...
![](/images/es6-tail-call-optimization/debug3.png)
...
![](/images/es6-tail-call-optimization/debug4.png)
...
![](/images/es6-tail-call-optimization/debug5.png)
...
<iframe
  width="560"
  height="315"
  src="https://www.youtube.com/embed/oorN1hGcgKs"
  frameborder="0"
...
{{ "/images/es6-tail-call-optimization/debug6.png" | figure: "Ungaught Ranger Error: Maximum call stack size exceeded" }}
...
{{ "/images/es6-tail-call-optimization/debug7.png" | figure: "Usage table for tail-call optimization, no browser implements it" }}
