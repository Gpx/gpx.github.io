...
<div className="highlight">
  The cool thing about our job is that we serve other industries and we learn
  from them.
</div>
...
<div className="highlight">
  Less regulated doesn’t mean illegal. Any fund, not only hedge funds, that acts
  illegaly gets shut down.
</div>
