...
Last Sunday, October 21st, I took part in [Hacktoberfest Barcelona](https://hacktoberfestbarcelona.com/). If you don't know what it is, Hacktoberfest is an initiative by DigitalOcean, GitHub
and Twilio. It encourages people to contribute to open-source projects for the whole
month of October.
...
if you've never done any open source before, we've all been beginners. At [firstpr.me](https://firstpr.me/) you can see what was the first PR for any GitHub user. Maybe you can get some
inspiration out of it. A few examples:

- [John Resig](https://firstpr.me/#jeresig) creator of jQuery, he wrote several books on JavaScript
- [Sarah Drasner](https://firstpr.me/#sdras) Vue core team member and O'Reilly published author
- [Kent C. Dodds](https://firstpr.me/#kentcdodds) react-testing-library creator. Works at Paypal and he's part of TC39
- [Peggy Rayzis](https://firstpr.me/#peggyrayzis) engineering manager Apollo and speaker
- [Jordan Walke](https://firstpr.me/#jordwalke) creator of React
- [Nicole Sullivan](https://firstpr.me/#stubbornella) Google Chrome project manager
- [Yehuda Katz](https://firstpr.me/#wycats) co-creator of Ember, Rust/Ruby on Rails/jQuery Core Team, TC39 member
- [Eve Porcello](https://firstpr.me/#eveporcello) JavaScript teacher and O'Reilly published author
- [Miško Hevery](https://firstpr.me/#mhevery) creator of Angular. Funny enough, it looks like the core developers of Angular
  opened Github just to work on their framework
- [Flarnie Marchan](https://firstpr.me/#flarnie) Facebook Software Engineer, React Core Team
- [André Staltz](https://firstpr.me/#staltz) creator of Cycle.js
- [Lea Verou](https://firstpr.me/#LeaVerou) W3C CSS Working Group invited expert. Her PR is from 2013 and is yet to be
  merged :)
...
better how this whole pull request thing works check out this great [Egghead course](https://egghead.io/courses/how-to-contribute-to-an-open-source-project-on-github).
...
> but the one in your mother tongue is missing? Open a&hellip; well you get the
> idea.
...
see if there's something you could help with. What are people saying on [Stack Overflow](https://stackoverflow.com/) about it? Are they confused about something? Sometimes a question could lead
to improving the documentation or refactoring some part of the code to make it easier
to work with.
...
Still don't know what to work on? [Up For Grabs](https://up-for-grabs.net/#/) has a list of projects that are looking for help. Check out if there's something
that could be interesting for you. Other great sources are [first-timers-only](https://github.com/search?utf8=%E2%9C%93&q=label%3Afirst-timers-only+is%3Aopen&type=Issues&ref=searchresults) and [awesome-for-beginners](https://github.com/MunGell/awesome-for-beginners). These are all projects that have decided to mark some of their issues for first
timers. When you find an issue you want to work on claim it. That means comment in
the issue page that you're going to work on it. This is to avoid having more than
one person fixing the same problem.
