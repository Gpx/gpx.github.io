...
<Img src="/how-to-style-text/1.png" alt="The default document" />

<Img src="/how-to-style-text/2.png" alt="The page after our styling" />
...
<Img src="/how-to-style-text/3.png" alt="Already looking better" />
...
<Img src="/how-to-style-text/4.png" alt="The light version" />
...
<iframe
  height="300"
  style={{ width: "100%", minHeight: "30rem", marginBottom: "2rem" }}
  scrolling="no"
