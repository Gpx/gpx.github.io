...
<figure>
  <a href="https://material-ui.com/demos/selects/" target="_blank">
    <img
      src="/testing-a-custom-select-with-react-testing-library/selects.gif"
      title="Material-UI's select"
    />
  </a>
...
<figure>
  <img
    src="/testing-a-custom-select-with-react-testing-library/custom-select.gif"
    title="MySelector in action"
  />
  <figcaption>
    <code>MySelector</code> in action
  </figcaption>
</figure>
